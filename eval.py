...
optparser.add_option("-e", dest="e_file", default="data/handards.e", help="E filename")
...
for (i, (f, e, g, a)) in enumerate(zip(open(opts.f_file), open(opts.e_file), open(opts.a_file), sys.stdin)):
